          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0">
                <h1
                  data-aos="fade-up"
                  className="text-3xl sm:text-4xl font-bold font-"
                >
                  Premium  Coffee
                </h1>
                <p
                ...
                >
                 Premium coffee could be defined as a clean, 
                 acceptable bean with a distinctive flavor in the cup,
                  but one that did not receive a high enough score to be considered specialty
                </p>
